...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        driver.find_element_by_xpath(
            "/html/body/div/div[2]/div/div[1]/div[1]/div[2]/table/tbody/tr[1]/th/a").click()
        time.sleep(3)
        driver.find_element_by_xpath(
            "/html/body/div/div[3]/div/div[1]/div/div/div/form/div[2]/table/tbody/tr/td[1]/input").click()
        time.sleep(3)
